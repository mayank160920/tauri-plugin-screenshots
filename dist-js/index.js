...
const getScreenshotableWindows = () => {
    return invoke(COMMAND.GET_SCREENSHOTABLE_WINDOWS);
};
/**
...
const getScreenshotableMonitors = () => {
    return invoke(COMMAND.GET_SCREENSHOTABLE_MONITORS);
};
/**
...
const getWindowScreenshot = (id) => {
    return invoke(COMMAND.GET_WINDOW_SCREENSHOT, { id });
};
/**
...
const getMonitorScreenshot = (id) => {
    return invoke(COMMAND.GET_MONITOR_SCREENSHOT, { id });
};
/**
...
const getMonitorScreenshotBase64url = (id) => {
    return invoke(COMMAND.GET_MONITOR_SCREENSHOT_BASE64URL, { id });
};
/**
...
export { COMMAND, clearScreenshots, getMonitorScreenshot, getMonitorScreenshotBase64url, getScreenshotableMonitors, getScreenshotableWindows, getWindowScreenshot, removeMonitorScreenshot, removeWindowScreenshot };
